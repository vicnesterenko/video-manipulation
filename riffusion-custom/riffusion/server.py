"""
Flask server that serves the riffusion-custom model as an API.
"""
...
def run_app(
    *,
    checkpoint: str = "riffusion-custom/riffusion-custom-model-v1",
    ...
    """
    Run a flask API that serves the given riffusion-custom model checkpoint.
    """
...
def run_inference():
    """
    Execute the riffusion-custom model as an API.
...
def compute_request(
    ...
    Args:
        ...
        pipeline: The riffusion-custom model pipeline
