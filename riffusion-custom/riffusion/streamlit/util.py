"""
Streamlit utilities (mostly cached wrappers around riffusion-custom code).
"""
import io
import threading
import typing as T
...
DEFAULT_CHECKPOINT = "riffusion-custom/riffusion-custom-model-v1"
...
def load_riffusion_checkpoint(
    ...
    """
    Load the riffusion-custom pipeline.
    """
