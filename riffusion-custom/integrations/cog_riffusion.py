...
MODEL_ID = "riffusion-custom/riffusion-custom-model-v1"
MODEL_CACHE = "riffusion-custom-cache"
...
class Output(BaseModel):
    """
    Output class for riffusion-custom predictions
    """
...
class RiffusionPredictor(BasePredictor):
    """
    Implementation of cog predictor object s.t. we can run riffusion-custom predictions w/cog.
    ...
    def predict(
        ...
        """
        Runs riffusion-custom inference.
        """
...
def download_weights():
    """
    Clears local cache & downloads riffusion-custom weights
    """
