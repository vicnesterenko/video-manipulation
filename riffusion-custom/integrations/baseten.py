...
files from /riffusion-custom in the standard /model directory of the Truss.
...
class Model:
    """
    Baseten Truss model class for riffusion-custom.
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.checkpoint_name = "riffusion-custom/riffusion-custom-model-v1"
